...
const AddColorModal: React.FC<AddColorModalProps> = ({ onClose, onAdd, suggestedColors }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex justify-center items-center z-50 font-sans" onClick={onClose}>
      <div 
        ref={modalRef}
        className="bg-surface backdrop-blur-2xl border border-border-color rounded-2xl shadow-2xl p-8 w-full max-w-sm relative" 
